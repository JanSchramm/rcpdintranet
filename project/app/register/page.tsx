    ...
    <div className="min-h-screen bg-[#0058a0] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative xp-window w-full max-w-md">
        ...
        <div className="xp-titlebar">
          ...
          <span className="flex-1 truncate">RCPD Officer Registration</span>
        ...
        <div className="p-6 bg-[#ece9d8] space-y-5">
          ...
          <div className="flex items-center gap-4 pb-4 border-b border-[#808080]">
            ...
            <div>
              ...
              <p className="text-xs text-[#404040] mt-0.5 font-mono">
                RCPD Officer Registration System
              </p>
          ...
          <div className="xp-sunken bg-[#fffbe6] p-3 text-xs text-[#404040] leading-relaxed">
            <p className="font-bold mb-1 text-[#0a246a]">OFFICER REGISTRATION</p>
            <p>
              Klicke unten, um dich mit deinem Discord-Account zu registrieren. 
              Nach der Registrierung muss dein Account von einem Administrator 
              freigeschaltet werden, bevor du Zugriff auf das RCPD Intranet erhältst.
            </p>
          </div>
        ...
        <div className="xp-statusbar">
          ...
          <div className="xp-statusbar-item ml-auto">
            <button 
              onClick={() => router.push('/')}
              className="text-[11px] text-[#0a246a] hover:underline"
            >
              Back to Login
            </button>
          </div>
